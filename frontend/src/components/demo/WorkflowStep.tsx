 ...
 * Renders step number, icon, module name, and connecting arrow.
 */
  ...
  return (
    <div className="relative flex flex-col items-center text-center sm:text-left sm:flex-row sm:items-start gap-4 p-4 rounded-xl bg-[#13131e] border border-border/60 hover:border-border transition-colors">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <div className={`h-8 w-8 rounded-lg flex items-center justify-center font-bold text-xs text-white ${theme.timelineColor} shadow-md`}>
          #{step.step}
        </div>
